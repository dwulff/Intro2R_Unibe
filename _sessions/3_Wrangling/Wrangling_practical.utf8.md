...
# ... with 2,129 more rows, and 24 more variables: preanti <int>,
...
#   age_m <dbl>, weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
...
# ... with 1,761 more rows, and 24 more variables: preanti <int>,
#   race <int>, gender <int>, str2 <int>, strat <int>, symptom <int>,
#   treat <int>, offtrt <int>, cd40 <int>, cd420 <int>, cd496 <int>,
#   r <int>, cd80 <int>, cd820 <int>, cens <int>, days <int>, arms <int>,
#   age_m <dbl>, weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
...
# A tibble: 2,110 x 34
 ...
 9 211314    19      50.8     0     0     0     90      0     0      1
10 340767    19      74.8     0     1     0    100      0     0      1
# ... with 2,100 more rows, and 24 more variables: preanti <int>,
#   race <int>, gender <int>, str2 <int>, strat <int>, symptom <int>,
#   treat <int>, offtrt <int>, cd40 <int>, cd420 <int>, cd496 <int>,
#   r <int>, cd80 <int>, cd820 <int>, cens <int>, days <int>, arms <int>,
#   age_m <dbl>, weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
...
# A tibble: 2,139 x 36
 ...
 9 211314    19      50.8     0     0     0     90      0     0      1
10 340767    19      74.8     0     1     0    100      0     0      1
# ... with 2,129 more rows, and 26 more variables: preanti <int>,
#   race <int>, gender <int>, str2 <int>, strat <int>, symptom <int>,
#   treat <int>, offtrt <int>, cd40 <int>, cd420 <int>, cd496 <int>,
#   r <int>, cd80 <int>, cd820 <int>, cens <int>, days <int>, arms <int>,
#   age_m <dbl>, weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
#   gender_char <chr>, arms_char <chr>, agem <dbl>, exercise <int>,
#   education <chr>
```
...
# ... with 116 more rows, and 26 more variables: preanti <int>,
#   race <int>, gender <int>, str2 <int>, strat <int>, symptom <int>,
#   treat <int>, offtrt <int>, cd40 <int>, cd420 <int>, cd496 <int>,
#   r <int>, cd80 <int>, cd820 <int>, cens <int>, days <int>, arms <int>,
#   age_m <dbl>, weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
...
# A tibble: 2,139 x 37
 ...
 9 211314    19      50.8     0     0     0     90      0     0      1
10 340767    19      74.8     0     1     0    100      0     0      1
# ... with 2,129 more rows, and 27 more variables: preanti <int>,
#   race <int>, gender <int>, str2 <int>, strat <int>, symptom <int>,
#   treat <int>, offtrt <int>, cd40 <int>, cd420 <int>, cd496 <int>,
#   r <int>, cd80 <int>, cd820 <int>, cens <int>, days <int>, arms <int>,
#   age_m <dbl>, weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
...
# ... with 27 more variables: preanti <int>, race <int>, gender <int>,
#   str2 <int>, strat <int>, symptom <int>, treat <int>, offtrt <int>,
#   cd40 <int>, cd420 <int>, cd496 <int>, r <int>, cd80 <int>,
#   cd820 <int>, cens <int>, days <int>, arms <int>, age_m <dbl>,
#   weight_lb <dbl>, cd_change_20 <int>, cd_change_960 <int>,
#   gender_char <chr>, arms_char <chr>, agem <dbl>, exercise <int>,
#   education <chr>, drugs_char <chr>
```

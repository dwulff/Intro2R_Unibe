...
If you've gotten this far, then you've really gotten the hang of R Markdown! Try adding the correct combination of text, tags, and code to add all of the results from the `happiness` data contained here: [Happiness.html](https://dwulff.github.io/Intro2R_Unibe/_sessions/Reporting/Reporting_answers.html)

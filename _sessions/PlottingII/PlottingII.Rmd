...
Address the <high>panel grid lines</high> using `panel.background` and that of the <high>plot background</high> using `plot.background` and change the color using `element_rect(fill = color)`.
...
myplot + 
  theme(
    ...
    plot.background = 
      element_rect(fill = 'burlywood'),
    panel.grid.major = 
      element_line(colour = "salmon", size=2),
    panel.grid.minor = 
      element_line(colour = "khaki", size=.5),
    )

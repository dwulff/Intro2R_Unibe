...
baselers <-read_delim(file = "../_data/baselers.csv",
                      delim = c(","))
```
...
R provides <high>all necessary tools to pull data from</high> or <high> directly work with</high> remote databases such as, e.g., a `SQL` database. Find out more at:
